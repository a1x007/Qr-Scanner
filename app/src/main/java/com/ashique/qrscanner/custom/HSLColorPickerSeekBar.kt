...
import codes.side.andcolorpicker.R as r
...
import com.ashique.qrscanner.custom.ColorSeekBar
...
class HSLColorPickerSeekBar @JvmOverloads constructor(
  ...
  private fun init(attrs: AttributeSet? = null) {
    ...
    mode = Mode.entries.toTypedArray()[typedArray.getInteger(
      r.styleable.HSLColorPickerSeekBar_hslMode,
      DEFAULT_MODE.ordinal
    )]
    coloringMode = ColoringMode.entries.toTypedArray()[typedArray.getInteger(
